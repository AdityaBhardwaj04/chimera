...
const Events = (props) => {
    ...
    return (
        <div className="w-[100vw] overflow-x-hidden bg-gradient-back pb-10">
            <div className="max-w-[1920px] p-3 xl:p-0 flex flex-col mx-auto ">
                <div className="p-3 xl:p-0 w-full xl:w-[1162px] mx-auto md:mt-[40px]">
                    ...
                    <div className="flex flex-col lg:flex-row justify-center gap-8 items-center mt-8">
                        ...
                        <div className="flex flex-col  justify-center items-center py-5 px-5 sm:py-10 sm:px-10 max-width-[500px] sm:h-[500px] sm:w-[500px] w-full rounded-xl sm:rounded-3xl  border-solid border-[0.92px] border-[#7F7F7F] blurbox bg-gradient-custom">
